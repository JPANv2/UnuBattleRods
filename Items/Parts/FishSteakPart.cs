...
namespace UnuBattleRods.Items.Parts
{
    public class FishSteakPart : ModItem
    {
        ...
        public string worldDisplay = "UnuBattleRods/Items/Parts/FishSteakPart_World";
        ...
        public override void AddRecipes()
        {
            ...
            recipe.SetResult(ModContent.ItemType<FishSteaks>(), 1);
            recipe.AddRecipe();
            recipe = new ModRecipe(this.mod);
            recipe.AddIngredient(ModContent.ItemType<FishSteaks>(), 1);
            recipe.SetResult(ModContent.ItemType<FishSteakPart>(), 1);
            recipe.AddRecipe();
